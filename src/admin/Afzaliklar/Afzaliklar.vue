<template>
    <div class="Afzaliklar">
        <SaidBar/>
        <div class="Afzaliklar-content">
            <div class="Afzaliklar-header">
                ...
                <div class="Afzaliklar-header__wrapper">
                    <h1>
                    Afzaliklar
                </h1>
    ...
    <style scoped>
        ...
        .Afzaliklar-header__wrapper{
            display: flex;
            align-items: center;
            gap: 50px;
        }
        .Afzaliklar-header h1{
            color: white;
            font-size: 50px;
            font-weight: bold;
        }
        .Afzaliklar-header button{
            padding: 10px 10px;
        ...
        .Afzaliklar-header button:hover{
            background-color: #624BFF;
            color: white;
        }
        .Afzaliklar-main{
        ...
        .Afzaliklar-footer span {
            color: white;
            font-size: 16px;
        }
        .Afzaliklar-footer button:hover {
