<template>
    <div class="Kurslar">
        <SaidBar/>
        <div class="Kurslar-content">
            <div class="Kurslar-header">
                ...
                <div class="Kurslar-header__wrapper">
                    <h1>
                    Kurslar
                </h1>
