<template>
    <div class="Rasmlar">
        <SaidBar/>
        <div class="Rasmlar-content">
            <div class="Rasmlar-header">
                ...
                <div class="Rasmlar-header__wrapper">
                    <h1>
                    Rasmlar
                </h1>
...
const editPartnership = () => {
    ...
    axios
        .put(`/slayd-images/update/${edit.id}`, formData, {
            headers: {
                Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
        })
...
const createPartnership = () => {
    ...
    axios
        .post("/slayd-images/create", formData, {
            headers: {
                Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
        })
